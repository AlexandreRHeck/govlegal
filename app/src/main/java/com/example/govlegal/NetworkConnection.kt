...
class NetworkConnection (private val context: Context): LiveData<Boolean>(){
    ...
    private lateinit var networkConnectionCallback: NetworkCallback
    ...
    private fun connectionCallback(): NetworkCallback{

        networkConnectionCallback = object : NetworkCallback(){
